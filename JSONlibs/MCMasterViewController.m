...
- (void)viewDidLoad
{
    ...
    _libraries = [[NSArray alloc] initWithObjects:@"JSONKit", @"JSONKitData", @"JSONKitThread", @"JSONKitThreadData", @"TouchJSON", @"NextiveJson", @"SBJson", @"SBJsonData", @"NSJSONSerialization", @"JsonLite", @"JsonLiteData", nil];
